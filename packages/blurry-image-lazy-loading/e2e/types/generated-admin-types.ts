...
export type AssetCustomFields = {
  ...
  previewImageHash?: Maybe<Scalars['String']['output']>;
};
...
export type AssetFilterParameter = {
  ...
  previewImageHash?: InputMaybe<StringOperators>;
...
export type AssetSortParameter = {
  ...
  previewImageHash?: InputMaybe<SortOrder>;
...
export type Mutation = {
   ...
   */
  pluginPreviewImageHashCreateImageHashesForProduct: PluginPreviewImageHashResult;
...
export type MutationPluginPreviewImageHashCreateImageHashesForCollectionArgs = {
  input: PluginPreviewImageHashForCollectionInput;
};


export type MutationPluginPreviewImageHashCreateImageHashesForProductArgs = {
...
export type PluginPreviewImageHashCreateInput = {
   ...
   * @default false
   */
  runSynchronously?: InputMaybe<Scalars['Boolean']['input']>;
...
export enum PluginPreviewImageHashResultCode {
  ENTITY_NOT_FOUND = 'ENTITY_NOT_FOUND',
  FAIL_EMPTY_BUFFER = 'FAIL_EMPTY_BUFFER',
  FAIL_ENCODE = 'FAIL_ENCODE',
  FAIL_FETCH = 'FAIL_FETCH',
  FAIL_SAVE_ASSET = 'FAIL_SAVE_ASSET',
  OK = 'OK',
  UNEXPECTED_ERROR = 'UNEXPECTED_ERROR',
  WRONG_MIMETYPE = 'WRONG_MIMETYPE'
}
...
export type CreatePreviewImageHashMutationVariables = Exact<{
  input: PluginPreviewImageHashCreateInput;
}>;
