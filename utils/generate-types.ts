...
export async function generateTypes(
    ...
    await generate({
      ...
      generates: {
        [path.join(options.pluginDir, outputFile)]: {
          plugins: ["typescript", ...(documents ? ["typescript-operations", "typed-document-node"] : [])],
        },
      },
    });
  }
  ...
  if (options.e2e === true || (typeof options.e2e === "object" && options.e2e.admin)) {
    tasks.push(
      generateTypes(
        "admin",
  ...
  if (options.e2e === true || (typeof options.e2e === "object" && options.e2e.shop)) {
    generateTypes(
      "shop",
